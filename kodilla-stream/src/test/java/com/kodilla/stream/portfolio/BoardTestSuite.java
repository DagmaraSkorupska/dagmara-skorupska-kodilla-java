...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        //When
        double sumOfTaskInProgress = project.getTaskLists().stream()
                .filter(tl -> tl.getName().equals("In progress"))
                .flatMap(t->t.getTasks().stream())
                .count();
        System.out.println(sumOfTaskInProgress);

        int sumOfDaysForTaskInProgress = 0;
        ...
        double averageDaysPerTaskInProgress = sumOfDaysForTaskInProgress / sumOfTaskInProgress;
        System.out.println("Average is: " + averageDaysPerTaskInProgress);

        //Then
        Assert.assertEquals(3, sumOfTaskInProgress, 0);
        Assert.assertEquals(10.0, averageDaysPerTaskInProgress, 0.001);
    }
}
